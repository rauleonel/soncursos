...
if(isset($course_user_meta_array) && is_array($course_user_meta_array) && count($course_user_meta_array)>0){
    ...
    <div class="my-courses">
    	<div class="cs-table">
            <ul class="top-sec">
                <li><?php _e('Curso','EDULMS'); ?></li>
                <!--<li><?php //_e('Maestro','EDULMS'); ?></li>-->
                <li><?php _e('Estado','EDULMS'); ?></li>
                <li></li>
            </ul>
        </div>
        <?php
							...
							if($course_key || $course_key == 0){
								...
								if(isset($user_course_data_array[$course_key]) && is_array($user_course_data_array[$course_key])){
									...
									if($disable == "1"){
										...
										if ( $status == 'Pass' ) {
											$course_status = 'Completo';
										} else if ( $status == 'Pending' ) {
											$course_status = 'Pendiente';
										} else if ( $status == 'Fail' ) {
											$course_status = '';
										} else {
											$course_status = 'Completo';
									...
									if(isset($course_status) && ($course_status == 'En proceso..' || $course_status == 'Completo' || $course_status == '' || $course_status == 'Pendiente' )){
									$counter_courses++;
									?>
									<script>
                                    ...
                                    <div class="cs-table">	
										<ul class="bottom-sec">
											<li>
												...
												?>
												<p>por <?php echo esc_attr($course_instructor);?></p>
											</li>
...
<?php 
	...
	_e('No ha contestado ninguna evaluación','EDULMS');
}